<head>
    ...
    <title>411 Metrics | Dashboard | 411 Metrics</title>
    ...
    <link href="<?php echo $this->config->base_url();?>r/css/style.css" rel="stylesheet">
   	...
   	<link href="<?php echo $this -> config -> base_url(); ?>r/css/bootstrap-material-datetimepicker.css" rel="stylesheet" type="text/css"/>
	...
	<script src="<?php echo $this -> config -> base_url(); ?>r/js/bootstrap-material-datetimepicker.js"></script>
